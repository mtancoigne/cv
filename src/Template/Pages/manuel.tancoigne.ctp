...
$competences = [
    ...
    'Frameworks' => [
        ...
        'data' => [
            "CakePHP" => [
                'stars' => 4,
                'projects' => ['Orma', 'Elabs', 'Croogo', 'SuperBake', 'Karl', 'CakePart',]
            ],
            "Laravel5" => [
                'stars' => 2,
    ...
    'Autres' => [
        ...
        'col' => 2,
        'data' => [
            'Solidworks' => ['stars' => 4,], 'Draftsight, Sketchup...'
        ]
    ]
];
...
$projs = [
    ...
    // Projets
    'Orma' => ['title' => 'Orma Architettura', 'description' => 'Backend du site de l\'agence d\'architectes Orma', 'link' => 'https://www.orma-architettura.com/', 'tech' => 'CakePHP, JS, Html/CSS', 'year' => 2017, 'type' => 'site'],
...
?>
    ...
    <ul class="card-content-list">
        <li>Trésorier de l'association "Les Bruits Sont Ardents", pour la promotion de la musique électronique
            (machines) pour des personnes en situation de handicap.
        </li>
    </ul>
                    ...
                    <div class="line">
                        <div class="col two">
                            <ul class="list-content">
                                <li><i class="fa fa-home fa-fw"></i> <a href="http://experimentslabs.com/"
                                                                        target="_blank">Site web</a></li>
                                <li class="print-only"><i class="fa fa-file-text fa-fw"></i> <a
                                            href="http://experimentslabs.com/cv" target="_blank">CV en ligne</a></li>
                                <li><i class="fa fa-google-plus-square fa-fw"></i> <a
                                            href="https://plus.google.com/+ManuelTancoigne" target="_blank">Google+</a>
                                </li>
                                <li><i class="fa fa-linkedin fa-fw"></i> <a
                                            href="https://www.linkedin.com/in/mtancoigne" target="_blank">LinkedIn</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col two">
                            <ul class="list-content">
                                <li><i class="fa fa-github fa-fw"></i> <a href="https//github.com/mtancoigne"
                                                                          target="_blank">Github</a></li>
                                <li><i class="fa fa-codepen fa-fw"></i> <a href="https://codepen.io/mtancoigne"
                                                                           target="_blank">Codepen.io</a></li>
                                <li><i class="fa fa-free-code-camp fa-fw"></i> <a
                                            href="https://freecodecamp.com/mtancoigne" target="_blank">Free Code
                                        Camp</a></li>
                                <li><i class="fa fa-globe fa-fw"></i> <a href="http://codecademy.com/mtancoigne"
            ...
            <div class="line">
                                                                    ...
                                                                    <strong>
                                                                        <?php if (isset($project['link'])) : ?>
                                                                            <a href="<?php echo $project['link'] ?>"
                                                                               target="_blank"><i
                                                                                        class="fa fa-external-link fa-fw"></i> <?php echo $project['title'] ?>
                                                                            </a>
                                                                        <?php else: ?>
                ...
                <div class="col one two-md four-sm col-experiences">
                    <div class="col-info">
                        ...
                        <h3>2014-2016 : <a href="http://metallerie.fr"
                                           target="_blank"><?php echo $this->Html->iconT('external-link', 'Métallerie Sarthoise') ?></a>
                        </h3>
                        <ul class="card-content-list">
                        ...
                        <h3>2007-2011 : <a href="http://artmetal72.com"
                                           target="_blank"><?php echo $this->Html->iconT('external-link', 'Art Métal 72') ?></a>
                        </h3>
                        <ul class="card-content-list">
                        ...
                        <h3>2006-2007 :</h3>
                        <ul class="card-content-list">
                            <li>Intérim en BTP pour découvrir des métiers manuels et garder l'informatique en passion
                            </li>
                        </ul>
                    </div>
                    <div class="col-info">
                        ...
                        <h3>2016</h3>
                        <ul class="card-content-list">
                            <li>Formation Développeur Logiciel à l'<a href="http://imie-ecole-informatique.fr"
                                                                      target="_blank">IMIE</a> : Diplôme BAC+2
                            </li>
